    ...
    <div className="min-h-screen bg-surface pt-14 pb-20">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-secondary-container/40 mb-4 animate-scale-in">
            <svg
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            <div className="flex items-center justify-between mb-4 pb-4 border-b border-gray-200">
              <div>
                ...
                <p className="text-lg font-semibold text-on-surface">{order.order_number}</p>
              </div>
              <div className="text-right">
                <p className="text-sm text-on-surface-variant">Amount Paid</p>
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="px-3 py-1 rounded-full text-sm font-medium bg-secondary-container/40 text-primary">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full bg-white text-on-surface py-3 px-6 rounded-lg font-medium border border-gray-300 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            onClick={() => navigate('/')}
            className="w-full text-primary py-3 px-6 rounded-lg font-medium hover:bg-secondary-container/30 transition-colors flex items-center justify-center gap-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
