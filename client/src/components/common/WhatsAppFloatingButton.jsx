...
const WhatsAppFloatingButton = () => {
  return (
    <a
      ...
      className="fixed right-4 bottom-24 md:bottom-6 z-40 w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:scale-105 active:scale-95 transition-transform flex items-center justify-center"
    >
