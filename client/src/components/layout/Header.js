          ...
          <div className="flex items-center gap-2 sm:gap-3 min-h-[2.75rem] md:min-h-0 md:flex-1 md:min-w-0">
            <Link to="/" className="flex-shrink-0 flex items-center gap-1 max-w-[8rem] sm:max-w-[9.5rem] sm:max-w-none">
              ...
              <div className="sm:hidden bg-white rounded-lg p-1">
                <img src="/logo-mobile.png" alt="CityFreshKart" className="h-9 w-auto object-contain" />
              </div>
              {/* Desktop logo - shown on sm and larger */}
              <img src="/CityFreshKart.png" alt="CityFreshKart" className="hidden sm:block h-9 sm:h-10 w-auto object-contain" />
            </Link>
            ...
            <div className="flex items-center gap-1 flex-shrink-0 ml-auto md:ml-0">
              ...
              {!user && (
                <Link
                  to="/login"
                  className="flex items-center gap-1.5 text-on-surface-variant hover:text-primary hover:bg-secondary-container/30 rounded-xl transition-colors px-2.5 sm:px-3 py-2 text-sm font-semibold"
                >
